...
?>
        ...
        <div class="container">
			<header>
				<h1 style="color: black;"><strong>Guest Accomodation Booking Form</strong> </h1>
				<h2 style="color: black;">Registered Users</h2>
			</header>
			
			<section class="main">
				<form class="form-2" method="POST" name="form1" onsubmit="return validate()" action="room_availability.php"  >
